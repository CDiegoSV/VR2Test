	...
	public class TCMEditor : EditorWindow {
		...
		private void CheckForMaterials(){
			...
			if(numColors == NumColors.TwoColors){
				...
				if(!borderMat){
					borderMat = new Material(Shader.Find("Universal Render Pipeline/Lit"));
				...
				if(!topBaseMat){
					topBaseMat = new Material(Shader.Find("Universal Render Pipeline/Lit"));
					AssetDatabase.CreateAsset(topBaseMat, "Assets/newTopBaseMaterial.mat");
				}
				if(!topBorderMat){
					topBorderMat = new Material(Shader.Find("Universal Render Pipeline/Lit"));
					AssetDatabase.CreateAsset(topBorderMat, "Assets/newTopBorderMaterial.mat");
				}
				if(!bottomBaseMat){
					bottomBaseMat = new Material(Shader.Find("Universal Render Pipeline/Lit"));
					AssetDatabase.CreateAsset(bottomBaseMat, "Assets/newBottomBaseMaterial.mat");
				}
				if(!bottomBorderMat){
					bottomBorderMat = new Material(Shader.Find("Universal Render Pipeline/Lit"));
